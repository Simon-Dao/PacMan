...
public class Tile {
    ...
    private boolean hasSpecialFruit = false;
    private int color;
    ...
    public boolean changeSpecialFruit(boolean hasSpecialFruit)
    {
        this.hasSpecialFruit = hasSpecialFruit;
        return hasSpecialFruit;
    }
